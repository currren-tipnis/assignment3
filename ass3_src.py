"""
Assignmnet 3 -  Python library to perform preprocessing for
a sentiment analysis task with a CNN + Embedding model.
"""
import re
import numpy as np
from twitter_tokenizer_functions import TweetTokenizer


class TextPreProcessor:
    """
    This convert a tweet to a padded word embeddings
    """

    def __init__(self, max_length_tweet=100, max_length_dictionary=2000000):

        """
        Initialize class to set base state
        """
    ...
    def tokenize_text(tweet_cleaned):
        ...
        # tokenize
        tokenized_tokens = tokenizer.tokenize(tweet_cleaned)
